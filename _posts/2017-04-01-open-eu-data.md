...
excerpt:    >
  Subsidystories.eu is a tool that enables the user to visualize, analyze and compare subsidy data across the European Union.
---
...
<img src="{{site.baseurl}}/assets/posts/2017-04/data-formats-subsidy.png" alt-text="Data Formats">
